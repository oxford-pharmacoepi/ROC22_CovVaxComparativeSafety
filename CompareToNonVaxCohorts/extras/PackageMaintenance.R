...
OhdsiRTools::checkUsagePackage("CompareToNonVaxCohorts")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/CompareToNonVaxCohorts")
shell("R CMD Rd2pdf ./ --output=extras/CompareToNonVaxCohorts.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "CompareToNonVaxCohorts")
...
OhdsiRTools::createRenvLockFile("CompareToNonVaxCohorts")
