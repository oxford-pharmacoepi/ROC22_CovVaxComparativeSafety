...
OhdsiRTools::checkUsagePackage("CovVaxComparativeSafety")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/CovVaxComparativeSafety.pdf")
shell("R CMD Rd2pdf ./ --output=extras/CovVaxComparativeSafety.pdf")
...
OhdsiRTools::createRenvLockFile("CovVaxComparativeSafety")
